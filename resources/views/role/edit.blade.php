                ...
                <div class="panel panel-default">
                    <div class="panel-heading" style="height: 46px;">
                        <h3 class="panel-title">
                            <strong class="pull-left" style="margin-top:6px;">编辑角色</strong>
                    ...
                    <div class="panel-body">
                        <div>
                            ...
                            <div class="form-group
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control input-sm" name="name" value="{{ old('name', $role->name) }}" placeholder="角色名称">
                                </div>
                                @if ($errors->has('name'))
                            ...
                            <div class="form-group
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control input-sm" name="level" value="{{ old('level', $role->level) }}" placeholder="级别">
                                </div>
                                @if ($errors->has('level'))
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <button class="btn btn-primary btn-xs normal-load-btn" data-loading-text="<span class='fa-spin ion-load-c'></span> 正在保存..." type="submit"><span class="fa fa-save"></span> 编辑角色</button>
                                </div>
                            </div>
                        </div>
                    </div>
