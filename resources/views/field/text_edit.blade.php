    ...
    <div style="width: 600px;">
        ...
        @endif
            ...
            <div class="col-sm-6">
                <label class="radio-inline">
                    <input
                        @if (old('widget', $addition->widget) == 'text')
                            checked="checked"
                        @endif
                        type="radio" name="widget" value="text" checked="checked"> 文本框
                </label>
                <label class="radio-inline">
                    <input
                        @if (old('widget', $addition->widget) == 'password')
                            checked="checked"
                        @endif
        ...
        @endif
            ...
            <div class="col-sm-6">
                <div class="input-group input-group-sm">
                    <input name="size_min" value="{{ old('size_min', $addition->size_min) }}" type="text" class="form-control">
                    <span class="input-group-addon"><span class="ion-code-working"></span></span>
                    <input name="size_max" value="{{ old('size_max', $addition->size_max) }}" type="text" class="form-control">
                </div>
            </div>
            @if ($errors->has('size_min') or $errors->has('size_max'))
        ...
        @endif
            ...
            <div class="col-sm-6">
                ...
                <label class="radio-inline" style="margin-left:10px">
                    <input
                    @if (old('rule', $addition->rule) == 'phone')
                        checked="checked"
                        @endif
                ...
                <label class="radio-inline">
                    <input
                    @if (old('rule', $addition->rule) == 'email')
                        checked="checked"
                        @endif
                ...
                <label class="radio-inline">
                    <input
                    @if (old('rule', $addition->rule) == 'date')
                        checked="checked"
                        @endif
                ...
                <label class="radio-inline">
                    <input
                    @if (old('rule', $addition->rule) == 'numeric')
                        checked="checked"
                        @endif
                ...
                <label class="radio-inline">
                    <input
                    @if (old('rule', $addition->rule) == 'integer')
                        checked="checked"
                        @endif
