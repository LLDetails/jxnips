...
@section('form')
    <div style="width: 600px;">
        ...
        <div class="form-group
            ...
            <div class="col-sm-6">
                <div class="input-group input-group-sm">
                    <input type="text" value="{{ old('size') }}" name="size" class="form-control" placeholder="单个文件大小">
        ...
        <div class="form-group
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control input-sm" name="count" value="{{ old('count') }}" placeholder="文件个数">
            </div>
            @if ($errors->has('count'))
