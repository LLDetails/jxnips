                ...
                <div class="panel panel-default">
                    <div class="panel-heading" style="height: 46px;">
                        <h3 class="panel-title">
                            <strong class="pull-left" style="margin-top:6px;">添加短信模板</strong>
                    ...
                    <div class="panel-body">
                        <div>
                            ...
                            <div class="form-group
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control input-sm" name="title" value="{{ old('title') }}" placeholder="模板标题">
                                </div>
                                @if ($errors->has('title'))
                            ...
                            <div class="form-group
                                ...
                                <div class="col-sm-6">
                                    <textarea name="txt" class="form-control" style="height: 200px;" placeholder="短信内容">{{ old('txt') }}</textarea>
                                </div>
                                @if ($errors->has('txt'))
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <button class="btn btn-primary btn-xs normal-load-btn" data-loading-text="<span class='fa-spin ion-load-c'></span> 正在提交..." type="submit"><span class="fa fa-plus-circle"></span> 添加短信模板</button>
                                </div>
                            </div>
                        </div>
                    </div>
