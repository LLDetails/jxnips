                ...
                <div class="panel panel-default">
                    <div class="panel-heading" style="height: 46px;">
                        <h3 class="panel-title">
                            <strong class="pull-left" style="margin-top:6px;">添加功能</strong>
                    ...
                    <div class="panel-body">
                        <div>
                            ...
                            <div class="form-group
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control input-sm" name="group" value="{{ old('group') }}" placeholder="功能组">
                                </div>
                                @if ($errors->has('group'))
                            ...
                            <div class="form-group
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control input-sm" name="name" value="{{ old('name') }}" placeholder="功能名称">
                                </div>
                                @if ($errors->has('name'))
                            ...
                            <div class="form-group
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control input-sm" name="route" value="{{ old('route') }}" placeholder="路由名称">
                                </div>
                                @if ($errors->has('route'))
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <button class="btn btn-primary btn-xs normal-load-btn" data-loading-text="<span class='fa-spin ion-load-c'></span> 正在提交..." type="submit"><span class="fa fa-plus-circle"></span> 添加功能</button>
                                </div>
                            </div>
                        </div>
                    </div>
