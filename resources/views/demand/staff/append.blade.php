                ...
                <div class="panel panel-default">
                    <div class="panel-heading" style="height: 46px;">
                        <h3 class="panel-title">
                            <strong class="pull-left" style="margin-top:6px;">{{ $basket->name }}需求追加物料</strong>
                    ...
                    <div class="panel-body">
                        <div>
                                ...
                                <div class="col-sm-6">
                                    <select class="form-control select2" name="goods_id">
                                        ...
                                        @foreach ($goods_records as $goods)
                                            <option @if(old('goods_id') == $goods->id) selected @endif data-unit="{{ $goods->unit }}" value="{{ $goods->id }}">[{{ $goods->code }}] {{ $goods->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                @if ($errors->has('goods_id'))
                            ...
                            <div class="form-group
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group input-group-sm">
                                        <input type="text" class="form-control" name="quantity" value="{{ old('quantity') }}" placeholder="采购量">
                            ...
                            <div class="form-group
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group input-group-sm">
                                        <input type="text" class="form-control" name="stock" value="{{ old('stock') }}" placeholder="当前库存">
                                        <span class="input-group-addon unit">吨</span>
                                    </div>
                                </div>
                                @if ($errors->has('stock'))
                            ...
                            <div class="form-group
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group input-group-sm">
                                        <input type="text" class="form-control" name="pending" value="{{ old('pending') }}" placeholder="未执行量">
                                        <span class="input-group-addon unit">吨</span>
                                    </div>
                                </div>
                                @if ($errors->has('pending'))
                            ...
                            <div class="form-group
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group input-group-sm">
                                        <input type="text" class="form-control" name="monthly_demand" value="{{ old('monthly_demand') }}" placeholder="本月需求量">
                                        <span class="input-group-addon unit">吨</span>
                                    </div>
                                </div>
                                @if ($errors->has('monthly_demand'))
                            ...
                            <div class="form-group form-group-sm">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group input-group-sm">
                                        <input readonly type="text" class="form-control day" name="day" value="{{ old('day') }}" placeholder="可用天数">
                    ...
                    <div class="panel-body">
                        <div>
                            <div class="form-group
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group input-group-sm">
                                        <input type="text" class="form-control" name="price_floor" value="{{ old('price_floor') }}" placeholder="报价下限">
                            ...
                            <div class="form-group
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group input-group-sm">
                                        <input type="text" class="form-control" name="price_caps" value="{{ old('price_caps') }}" placeholder="报价上限">
                                        <span class="input-group-addon punit">元/吨</span>
                                    </div>
                                </div>
                                @if ($errors->has('price_caps'))
                            ...
                            {{--<div class="form-group--}}
                                ...
                                {{--<div class="col-sm-6">--}}
                                    {{--<input type="text" class="form-control" name="price_validity" value="{{ old('price_validity') }}" placeholder="报价有效期">--}}
                                {{--</div>--}}
                                {{--@if ($errors->has('price_validity'))--}}
                                ...
                                <div class="col-sm-6">
                                    <select class="form-control" name="assign_rule">
                                        ...
                                        @foreach ($assign_rules as $rule)
                                            ...
                                            ?>
                                            <option @if(old('assign_rule') == $rule->id) selected @endif value="{{ $rule->id }}">{{ $rule->name }} {{ $assign_rule_data }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                @if ($errors->has('assign_rule'))
                            ...
                            <div class="form-group
                                ...
                                <div class="col-sm-6">
                                    <select class="form-control" name="invoice">
                                        <option @if(old('invoice')=='增值税普通发票') selected @endif value="增值税普通发票">增值税普通发票</option>
                                        <option @if(old('invoice')=='增值税专用发票') selected @endif value="增值税专用发票">增值税专用发票</option>
                                        <option @if(old('invoice')=='增值税普通或专用发票') selected @endif value="增值税普通或专用发票">增值税普通或专用发票</option>
                                    </select>
                                </div>
                                @if ($errors->has('invoice'))
                            ...
                            <div class="form-group
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" name="payment" value="{{ old('payment', '货到15天内付款') }}" placeholder="付款方式">
                                </div>
                                @if ($errors->has('payment'))
                            ...
                            <div class="form-group
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control date" name="delivery_date_start" value="{{ old('delivery_date_start') }}" placeholder="到货日（起）">
                                </div>
                                @if ($errors->has('delivery_date_start'))
                            ...
                            <div class="form-group
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control date" name="delivery_date_stop" value="{{ old('delivery_date_stop') }}" placeholder="到货日（止）">
                                </div>
                                @if ($errors->has('delivery_date_stop'))
