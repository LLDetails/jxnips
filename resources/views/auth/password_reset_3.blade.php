    ...
    <div class="panel panel-default" id="login-wrapper" style="border: none">
        <div class="panel-body">
            ...
            <form method="post" action="{{ URL::full() }}">
                <p class="text-info"><span class="fa fa-info"></span> 请设置新的密码</p>
                <div class="form-group">
                    <div class="input-group">
                        <span class="input-group-addon">新的密码</span>
                        <input type="password" name="password" value="" class="form-control" placeholder="请输入新的密码">
                    </div>
                </div>
                <div class="form-group">
                    <div class="input-group">
                        <span class="input-group-addon">校验密码</span>
                        <input type="password" name="repassword" value="" class="form-control" placeholder="请再次输入新的密码">
                    </div>
                </div>
                <input type="hidden" name="step" value="3" />
                {!! csrf_field() !!}
                <button id="login-btn" type="submit" class="btn btn-success btn-block" data-loading-text="<span class='fa-spin ion-load-c'></span> 提交中...">设置新密码</button>
