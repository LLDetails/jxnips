                        ...
                        <div>
                            ...
                            @if ( ! empty($supplier_type))
                                <div class="form-group
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control input-sm" name="name" value="{{ old('name', $user->supplier->name) }}" placeholder="供应商名称">
                                    </div>
                                    @if ($errors->has('name'))
                                ...
                                @if ($supplier_type == '企业法人' or $supplier_type == '个体户')
                                    <div class="form-group
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control input-sm" name="business_license" value="{{ old('business_license', $user->supplier->business_license) }}" placeholder="营业执照号">
                                        </div>
                                        @if ($errors->has('business_license'))
                                    ...
                                    <div class="form-group
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control input-sm" name="tax_id" value="{{ old('tax_id', $user->supplier->tax_id) }}" placeholder="税务登记号">
                                        </div>
                                        @if ($errors->has('tax_id'))
                                ...
                                @if ($supplier_type == '企业法人')
                                    <div class="form-group
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control input-sm" name="organization_code" value="{{ old('organization_code', $user->supplier->organization_code) }}" placeholder="组织机构代码">
                                        </div>
                                        @if ($errors->has('organization_code'))
                                    ...
                                    <div class="form-group
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control input-sm" name="registered_capital" value="{{ old('registered_capital', $user->supplier->registered_capital) }}" placeholder="注册资本">
                                        </div>
                                        @if ($errors->has('registered_capital'))
                                    ...
                                    <div class="form-group
                                        ...
                                        <div class="col-sm-6">
                                            <div class="input-group input-group-sm">
                                                <input type="text" class="form-control input-sm" name="company_scale" value="{{ old('company_scale', $user->supplier->company_scale) }}" placeholder="企业规模">
                                ...
                                @if ($supplier_type == '自然人')
                                    <div class="form-group
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control input-sm" name="id_number" value="{{ old('id_number', $user->supplier->id_number) }}" placeholder="身份证号">
                                        </div>
                                        @if ($errors->has('id_number'))
                                ...
                                <div class="form-group
                                    ...
                                    <div class="col-sm-6">
                                        <?php
                                            $supply_goods = json_decode($user->supplier->goods);
                                        ?>
                                            ...
                                            @foreach ($categories as $category)
                                                <optgroup label="[{{ $category->code }}] {{ $category->name }}">
                                                    @foreach ($category->goods_records as $goods_item)
                                                        <option @if(in_array($goods_item->id, old('goods', $supply_goods))) selected @endif value="{{ $goods_item->id }}">[{{ $goods_item->code }}] {{ $goods_item->name }}</option>
                                                    @endforeach
                                                </optgroup>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control input-sm" name="password" value="{{ old('password') }}" placeholder="登录密码，不改变则留空">
                                    </div>
                                    @if ($errors->has('password'))
                        ...
                        @if ( ! empty($supplier_type))
                            <div>
                                <div class="form-group
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control input-sm" name="bank" value="{{ old('bank', $user->supplier->bank) }}" placeholder="开户银行">
                                    </div>
                                    @if ($errors->has('bank'))
                                ...
                                <div class="form-group
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control input-sm" name="bank_account" value="{{ old('bank_account', $user->supplier->bank_account) }}" placeholder="银行帐号">
                                    </div>
                                    @if ($errors->has('bank_account'))
                                ...
                                <div class="form-group
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control input-sm" name="contact" value="{{ old('contact', $user->supplier->contact) }}" placeholder="联系人">
                                    </div>
                                    @if ($errors->has('contact'))
                                ...
                                <div class="form-group
                                    ...
                                    <div class="col-sm-6">
                                        <?php
                                            ...
                                            $tel = trim($tel);
                                        ?>
                                        <textarea name="tel" class="form-control" rows="3" placeholder="每行填写一个联系电话，可填写多行">{{ old('tel', $tel) }}</textarea>
                                    </div>
                                    @if ($errors->has('tel'))
                                ...
                                <div class="form-group
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control input-sm" name="zipcode" value="{{ old('zipcode', $user->supplier->zipcode) }}" placeholder="邮编">
                                    </div>
                                    @if ($errors->has('zipcode'))
                                ...
                                <div class="form-group
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control input-sm" name="address" value="{{ old('address', $user->supplier->address) }}" placeholder="地址">
                                    </div>
                                    @if ($errors->has('address'))
                                ...
                                <div class="form-group
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control input-sm" name="fax" value="{{ old('fax', $user->supplier->fax) }}" placeholder="传真">
                                    </div>
                                    @if ($errors->has('fax'))
                                ...
                                <div class="form-group
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control input-sm" name="email" value="{{ old('email', $user->supplier->email) }}" placeholder="电子邮箱">
                                    </div>
                                    @if ($errors->has('email'))
                                ...
                                <div class="form-group
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control input-sm" name="website" value="{{ old('website', $user->supplier->website) }}" placeholder="网站">
                                    </div>
                                    @if ($errors->has('website'))
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <button class="btn btn-primary btn-xs normal-load-btn" data-loading-text="<span class='fa-spin ion-load-c'></span> 正在保存..." type="submit"><span class="fa fa-save"></span> 编辑供应商</button>
                                    </div>
                                </div>
                            </div>
                        @endif
