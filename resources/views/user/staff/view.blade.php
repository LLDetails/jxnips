                    ...
                    <div class="panel-body">
                        <div>
                            ...
                            <div class="form-group form-group-sm">
                                ...
                                <div class="col-sm-6">
                                    <p class="form-control-static">{{ $user->staff->address }}</p>
                                </div>
                            </div>
                    ...
                    <div class="panel-body">
                        <div>
                            <div class="form-group form-group-sm">
                                ...
                                <div class="col-sm-6">
                                    <p class="form-control-static">{{ $user->staff->realname }}</p>
                                </div>
                            </div>
                            <div class="form-group form-group-sm">
                                <label class="col-sm-2 control-label">入职时间</label>
                                <div class="col-sm-6">
                                    <p class="form-control-static">{{ $user->staff->hiredate }}</p>
                                </div>
                            </div>
                            <div class="form-group form-group-sm">
                                <label class="col-sm-2 control-label">入职方式</label>
                                <div class="col-sm-6">
                                    <p class="form-control-static">{{ $user->staff->regular ? '正式聘用' : '临时工' }}</p>
                                </div>
                            </div>
                            <div class="form-group form-group-sm">
