                    ...
                    <div class="panel-body">
                        <div>
                            ...
                            <div class="form-group
                                ...
                                <div class="col-sm-6">
                                    <select class="form-control input-sm select2" name="company_id">
                            ...
                            <div class="form-group
                                ...
                                <div class="col-sm-6">
                                    <select class="form-control input-sm select2" name="category_id">
                    ...
                    <div class="panel-body">
                        <div>
                            <div class="form-group
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control input-sm" name="realname" value="{{ old('realname') }}" placeholder="真实姓名">
                                </div>
                                @if ($errors->has('realname'))
                            ...
                            <div class="form-group
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group input-group-sm">
                                        <input type="text" class="form-control input-sm date" name="hiredate" value="{{ old('hiredate') }}" placeholder="入职时间">
                            ...
                            <div class="form-group
                                ...
                                <div class="col-sm-6">
                                    <select class="form-control input-sm" name="is_regular">
                                        ...
                                        <option @if(old('is_regular') == 'true') selected @endif value="true">正式聘用</option>
                                        <option @if(old('is_regular') == 'false') selected @endif value="false">临时工</option>
                                    </select>
                                </div>
                                @if ($errors->has('is_regular'))
                            ...
                            <div class="form-group
                                ...
                                <div class="col-sm-6">
                                    <textarea name="address" class="form-control" rows="3" placeholder="请填写联系地址">{{ old('address') }}</textarea>
                                </div>
                                @if ($errors->has('address'))
                            ...
                            <div class="form-group
                                ...
                                <div class="col-sm-6">
                                    <textarea name="phone" class="form-control" rows="3" placeholder="每行填写一个联系电话，可填写多行">{{ old('phone') }}</textarea>
                                </div>
                                @if ($errors->has('phone'))
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <button class="btn btn-primary btn-xs normal-load-btn" data-loading-text="<span class='fa-spin ion-load-c'></span> 正在提交..." type="submit"><span class="ion-person-add"></span> 新建用户</button>
                                </div>
                            </div>
                        </div>
                    </div>
