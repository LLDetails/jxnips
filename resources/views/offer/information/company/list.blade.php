        ...
        <tr class="info">
            <th colspan="12">
                ...
                <div class="btn-group btn-group-sm" role="group" style="margin-left: 20px;">
                    <a href="{{ route('offer.information.company.list', ['offer_basket' => $offer_basket->id]) }}" class="btn btn-default btn-sm">按物料分组</a>
                    <a href="javascript:void(0)" type="button" class="btn btn-default btn-sm active">按供应商分组</a>
                </div>
            </th>
        </tr>
        <tr>
        ...
        @foreach ($information as $key=>$item)
            ...
            <tr class="data-row">
                ...
                <td rowspan="{{ $rowspan }}" class="text-center">
                    ...
                    @if (!isset($information[$key+1]) or (isset($information[$key+1]) and $information[$key+1]->supplier_id != $current_supplier))
