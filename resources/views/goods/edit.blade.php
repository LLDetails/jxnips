                ...
                <div class="panel panel-default">
                    <div class="panel-heading" style="height: 46px;">
                        <h3 class="panel-title">
                            <strong class="pull-left" style="margin-top:6px;">编辑商品</strong>
                    ...
                    <div class="panel-body">
                        <div>
                                ...
                                <div class="col-sm-6">
                                    <select data-url="{{ route('goods.add') }}" class="form-control input-sm select2" name="category_id">
                                        ...
                                        @foreach ($categories as $category)
                                            <option @if(old('category_id', Input::get('category_id', $goods->category_id)) == $category->id) selected @endif value="{{ $category->id }}">[{{ $category->code }}] {{ $category->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                @if ($errors->has('category_id'))
                            ...
                            @if ($errors->has('name'))
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control input-sm" name="name" value="{{ old('name', $goods->name) }}" placeholder="商品名称">
                                </div>
                                @if ($errors->has('name'))
                            ...
                            <div class="form-group
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control input-sm" name="code" value="{{ old('code', $goods->code) }}" placeholder="合同代号">
                                </div>
                                @if ($errors->has('code'))
                            ...
                            <div class="form-group
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control input-sm" name="unit" value="{{ old('unit', $goods->unit) }}" placeholder="计量单位">
                                </div>
                                @if ($errors->has('unit'))
                            ...
                            <div class="form-group
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input type="text" class="form-control input-sm" name="price_validity" value="{{ old('price_validity', $goods->price_validity) }}" placeholder="报价有效期">
                            ...
                            @if ($errors->has('quality_standard'))
                                ...
                                <div class="col-sm-6">
                                    <textarea name="quality_standard" class="form-control" rows="3" placeholder="质量标准">{{ old('quality_standard', $goods->quality_standard) }}</textarea>
                                </div>
                                @if ($errors->has('quality_standard'))
                    ...
                    <div class="panel-body">
                        <div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <button class="btn btn-primary btn-xs normal-load-btn" data-loading-text="<span class='fa-spin ion-load-c'></span> 正在保存..." type="submit"><span class="fa fa-save"></span> 编辑商品</button>
                                </div>
                            </div>
                        </div>
                    </div>
