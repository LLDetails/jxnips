                ...
                <div class="panel panel-default">
                    <div class="panel-heading" style="height: 46px;">
                        <h3 class="panel-title">
                            <strong class="pull-left" style="margin-top:6px;">编辑到货方式</strong>
                    ...
                    <div class="panel-body">
                        <div>
                            ...
                            <div class="form-group
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control input-sm" name="mode" value="{{ old('mode', $delivery_mode->mode) }}" placeholder="到货方式">
                                </div>
                                @if ($errors->has('mode'))
                            ...
                            <div class="form-group
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group">
                                        <input type="text" class="form-control input-sm" name="costs" value="{{ old('costs', $delivery_mode->costs) }}" placeholder="费用">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <button class="btn btn-primary btn-xs normal-load-btn" data-loading-text="<span class='fa-spin ion-load-c'></span> 正在保存..." type="submit"><span class="fa fa-save"></span> 编辑到货方式</button>
                                </div>
                            </div>
                        </div>
                    </div>
