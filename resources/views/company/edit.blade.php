                ...
                <div class="panel panel-default">
                    <div class="panel-heading" style="height: 46px;">
                        <h3 class="panel-title">
                            <strong class="pull-left" style="margin-top:6px;">编辑分公司</strong>
                    ...
                    <div class="panel-body">
                        <div>
                            ...
                            <div class="form-group
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control input-sm" name="name" value="{{ old('name', $company->name) }}" placeholder="公司名称">
                                </div>
                                @if ($errors->has('name'))
                            ...
                            <div class="form-group
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control input-sm" name="code" value="{{ old('code', $company->code) }}" placeholder="公司合同代号">
                                </div>
                                @if ($errors->has('code'))
                                ...
                                <div class="col-sm-6">
                                    <select @if(auth()->user()->role->name != '超级管理员') disabled @endif class="form-control input-sm select2" name="area_id">
                                        ...
                                        @foreach ($areas as $area)
                                            <option @if(old('area_id', $company->area_id) == $area->id) selected @endif value="{{ $area->id }}">{{ $area->name }}</option>
                                        @endforeach
                                    </select>
                                    @if(auth()->user()->role->name != '超级管理员')
                                        <input type="hidden" name="area_id" value="{{ $company->area_id }}" />
                                    @endif
                                </div>
                                @if ($errors->has('area_id'))
                            ...
                            <div class="form-group
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control input-sm" name="delivery_address" value="{{ old('delivery_address', $company->delivery_address) }}" placeholder="合同交付地址">
                                </div>
                                @if ($errors->has('delivery_address'))
                            ...
                            <div class="form-group
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control input-sm" name="contract_contact" value="{{ old('contract_contact', $company->contract_contact) }}" placeholder="合同联系人">
                                </div>
                                @if ($errors->has('contract_contact'))
                            ...
                            <div class="form-group
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control input-sm" name="contract_tel" value="{{ old('contract_tel', $company->contract_tel) }}" placeholder="合同电话">
                                </div>
                                @if ($errors->has('contract_tel'))
                            ...
                            <div class="form-group
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control input-sm" name="contract_fax" value="{{ old('contract_fax', $company->contract_fax) }}" placeholder="合同传真">
                                </div>
                                @if ($errors->has('contract_fax'))
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <button class="btn btn-primary btn-xs normal-load-btn" data-loading-text="<span class='fa-spin ion-load-c'></span> 正在保存..." type="submit"><span class="fa fa-save"></span> 编辑分公司</button>
                                </div>
                            </div>
                        </div>
                    </div>
