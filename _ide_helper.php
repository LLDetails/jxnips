 ...
 * Generated for Laravel 5.1.23 (LTS) on 2016-04-11.
 *
...
namespace {
    ...
    class IPSHelper extends \App\Services\IPSHelper{
        
    }


    class HSms extends \App\Facades\HSmsFacade{
         ...
         * @static 
         */
        public static function send($template_code, $phone, $param, $extend = ''){
            return \App\Services\HSms::send($template_code, $phone, $param, $extend);
        }
