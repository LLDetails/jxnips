...
class StaffAdditionController extends AdditionValidatorController
{
    public function index()
    {
        ...
        return view('user.staff.addition.index')
    ...
    public function add(Request $request)
    {
        ...
        return view($view)
            ->with('layout', 'user.staff.addition.add')
    ...
    public function append(Request $request)
    {
        ...
        $addition = Setting::firstOrCreate(['name' => 'staff_addition']);
        if (empty($addition) or empty($addition->data)) {
            $addition_data = [];
        } else {
    ...
    public function edit($addition_id)
    {
        ...
        return view($view)
            ->with('layout', 'user.staff.addition.edit')
