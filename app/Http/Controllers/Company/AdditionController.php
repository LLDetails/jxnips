...
class AdditionController extends AdditionValidatorController
{
    public function index()
    {
        ...
        return view('company.addition.index')
    ...
    public function add(Request $request)
    {
        ...
        return view($view)
            ->with('layout', 'company.addition.add')
    ...
    public function append(Request $request)
    {
        ...
        $addition = Setting::firstOrCreate(['name' => 'company_addition']);
        if (empty($addition) or empty($addition->data)) {
            $addition_data = [];
        } else {
        ...
        $addition->name = 'company_addition';
        if ($addition->save()) {
    ...
    public function edit($addition_id)
    {
        ...
        return view($view)
            ->with('layout', 'company.addition.edit')
